...
* Données annuelles concernant huit droits civils et politiques pour un maximum de 39 pays pour les années 2017-2021, avec plus de pays ajoutés chaque année. Notez que moins d'années de données seront disponibles pour les pays qui ont été ajoutés à l'échantillon de l'enquête plus récemment.

...
Nos données 2021 incluent les informations suivantes :
* Données annuelles concernant cinq droits économiques et sociaux pour 194 pays (selon le droit concerné) de 2007 à 2018, basé sur la méthodologie primée de <a href="https://serfindex.uconn.edu/" target="_blank">l'indice SERF</a>.
* Données annuelles concernant huit droits civils et politiques pour un maximum de 39 pays pour les années 2017-2020, avec plus de pays ajoutés chaque année. Notez que moins d'années de données seront disponibles pour les pays qui ont été ajoutés à l'échantillon de l'enquête plus récemment.
